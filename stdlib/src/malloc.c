...
// Based off tinyalloc https://github.com/thi-ng/tinyalloc
...
bool malloc_check()
{
    return heap_max_blocks == malloc_num_free() + malloc_num_used() + malloc_num_fresh();
}
